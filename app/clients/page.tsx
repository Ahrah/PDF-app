      ...
      <div className="flex justify-between items-center mb-8 flex-wrap gap-3">
        ...
        <div className="flex gap-2">
          <Link href="/clients/import">
            <Button variant="soft">고객 일괄등록</Button>
          </Link>
        ...
        <Card>
          <div className="text-center py-12">
            ...
            <div className="flex gap-2 justify-center">
              <Button onClick={() => setShowModal(true)}>고객 추가</Button>
              <Link href="/clients/import">
                <Button variant="soft">엑셀로 일괄등록</Button>
              </Link>
            </div>
          </div>
        </Card>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredClients.map((client) => (
            <Link
              ...
              className="block p-4 bg-white border border-gray-200 rounded-xl hover:border-primary-300 hover:shadow-sm transition"
            >
